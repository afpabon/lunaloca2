  ...
  <>
    <div className='col-md-12 bg-light'>
      <div className='row m-2'>
        ...
        <div className='col-lg-4 col-md-6 col-sm-12'>
          <h1 className='text-highlight title-text'>Pastelería Por Encargo</h1>
          <p>
            Deliciosas tortas, cupcakes, cake pops, brownies, pies, galletas y
            mucho mas, con recetas 100% artesanales y caseras para que deleites
            tu paladar.
          </p>
          <p>Tu lo imaginas, nosotros lo horneamos!</p>
          <div className='highlighted-box text-center'>
            <p>Informes:​</p>
      ...
      <div className='row m-2'>
        <div className='col-lg-6 col-sm-12'>
          <RemoteImage img='v1588170737/2524a6_c64aba0c6e79428189cb4567f4f25a74_lg9ocw.jpg' />
        </div>
